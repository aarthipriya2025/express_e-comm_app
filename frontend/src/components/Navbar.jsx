      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 md:px-12 py-3">
        ...
        <div className="hidden sm:flex flex-1 justify-center">
          <input
            ...
            className="w-full md:w-[500px] sm:w-[70%] px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400"
          />
        </div>
        ...
        <div className="flex items-center gap-9 relative">
          ...
          <div className="relative">
            <button
              className="flex items-center gap-1 text-gray-700 hover:text-blue-600 border-none text-xl font-black md:font-extrabold"
